 ...
 * @author Y.R.T.L.
 */
public class Examen_casa_YRTL {
    
        public  static int vec[]={20,12,28,24,8,4,16};
        public static void imprimirOrdenamientoRecursivoYRTL() {
	...
	public static int buscaBinariaRecursiva(int[] array, int menor, int mayor,int chave) {
        ...
        public static void imprimirBusquedaBinariaRecursivaYRTL() {
	...
	System.out.println("Ingrese la opción que desee probar:");
        ...
        while (opcion!=0) {            
            switch(opcion){
            case 1: imprimirOrdenamientoRecursivoYRTL(); break;
            case 2: imprimirBusquedaBinariaRecursivaYRTL();break;
